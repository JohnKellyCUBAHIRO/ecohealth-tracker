...
const DATA = {
    ADEME_2022: buildData(ADEME_2022)
};
export default class Food {
    ...
    constructor(dataSet, data) {
         ...
         */
        this.getEmissionEstimated = (consumption) => {
            let emission = 0;
            let waste = 0;
            for (const [key, value] of Object.entries(consumption)) {
                ...
                const food = key;
                const yearlyWeight = (value * this.data.foods[food].averageWeight * 52) / 1000; // (from g to Kg)
