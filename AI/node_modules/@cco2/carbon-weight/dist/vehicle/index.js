...
export default class Vehicle {
    ...
    constructor(dataSet, data) {
         ...
         */
        this.getEmissionConsumed = (consumption) => {
            ...
            const consumed = consumption.consumption !== undefined
         ...
         */
        this.getEmissionAvgByVehicle = () => {
            if (this.avgEmissionByVehicle)
       ...
       *   -1 in case of error (missing information)
       */
        this.getEmissionMileage = (vehicle) => {
            // We either needs emissionFactor or consumption && fuel
            if ((vehicle.emissionFactor === undefined &&
            ...
            if (vehicle.consumption !== undefined)
                return this.getEmissionConsumed({
                    consumption: (vehicle.consumption * vehicle.distanceByYear) / 100,
                    fuel: vehicle.fuel
                });
         ...
         */
        this.getEmissionEstimated = (model) => {
            var _a, _b, _c;
            const vehicleData = (_c = (_b = (_a = this.data.emissionFigure) === null || _a === void 0 ? void 0 : _a.vehicle) === null || _b === void 0 ? void 0 : _b[model.type]) === null || _c === void 0 ? void 0 : _c[model.fuel];
            if (!vehicleData)
                return -1;
