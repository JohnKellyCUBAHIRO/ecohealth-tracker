 ...
 */
export const getDistance = (fromLat, fromLon, toLat, toLon) => {
...
export default class Flight {
    ...
    constructor(dataSet, data) {
         ...
         */
        this.getEmissionEstimated = (travel, nbFlights) => {
         ...
         */
        this.getEmissionAvgByPassenger = () => {
            if (this.avgEmissionByPassenger)
